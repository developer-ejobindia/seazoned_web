<div class="chat-section-header">
    <div class="chat-user p-x-30 p-y-20" >
        <div class="media m-b-4"> 
            ...
            <?php  Session::put('key2', $customer_id);  ?>
    ...
    <div class="chat-form">
        <form class=""action="javascript:void(0);" method="post" id="land_message_add" onsubmit="addMessage('<?php echo session('key');; ?>', '<?php echo session('key1');; ?>', '<?php echo session('key2');; ?>','<?php echo session('key3');; ?>')">
...
<div class="chat-bubble clearfix mCustomScrollbar">
    <div class=" p-x-50 p-y-25 " id="chat-window">
        <?php
