...
@section('content')
    <form action="{{ url("add-landscapper-final") }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card side-menu m-b-30">
                            <div class="card-block p-t-30 p-b-30">
                                ...
                                <h5 class="address text-center m-0 m-t-20"><i class=" fa fa-location-arrow"></i> {{ session("temp_street_address") }} </h5>
                                <h4 class="profile-name text-center m-0 m-t-10">{{ session("temp_first_name") . " " . session("temp_last_name") }}</h4>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="register-heading m-b-30 ">
                            <h2 class="light m-b-20"><span class="regular">Welcome !</span> {{ session("temp_first_name") . " " . session("temp_last_name") }}</h2>
